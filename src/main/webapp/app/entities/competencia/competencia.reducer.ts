...
export const ACTION_TYPES = {
  ...
  PARTIAL_UPDATE_COMPETENCIA: 'competencia/PARTIAL_UPDATE_COMPETENCIA',
...
export default (state: CompetenciaState = initialState, action): CompetenciaState => {
  switch (action.type) {
    ...
    case REQUEST(ACTION_TYPES.PARTIAL_UPDATE_COMPETENCIA):
      return {
        ...state,
        errorMessage: null,
        updateSuccess: false,
    ...
    case FAILURE(ACTION_TYPES.PARTIAL_UPDATE_COMPETENCIA):
    ...
    case SUCCESS(ACTION_TYPES.PARTIAL_UPDATE_COMPETENCIA):
      return {
        ...state,
        updating: false,
        updateSuccess: true,
...
export const partialUpdate: ICrudPutAction<ICompetencia> = entity => async dispatch => {
  const result = await dispatch({
    type: ACTION_TYPES.PARTIAL_UPDATE_COMPETENCIA,
