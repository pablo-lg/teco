  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="gempBoostrapApp.estado.home.createOrEditLabel" data-cy="EstadoCreateUpdateHeading">
          ...
          {loading ? (
            ...
            <AvForm model={isNew ? {} : estadoEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                ...
                <AvField id="estado-descripcion" data-cy="descripcion" type="text" name="descripcion" />
              </AvGroup>
